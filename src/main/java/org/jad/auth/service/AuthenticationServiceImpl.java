...
import static org.jad.auth.enums.Role.ADMIN;
import static org.jad.auth.enums.Role.FOURNISSEUR;
...
public class AuthenticationServiceImpl implements AuthenticationService{
    ...
    public User signup(SignupRequest signupRequest) {
        User user;
        RoleEntity roleEntity = roleRepository.findByName(signupRequest.getRole());
        if (roleEntity == null) {
            throw new RuntimeException("Role not found: " + signupRequest.getRole());
        }
        switch (signupRequest.getRole()) {
            case "USER":
                user = Client.builder() // <--- utiliser Client si Role = USER
            ...
            case "FOURNISSEUR":
                user = Fournisseur.builder() // <--- utiliser Fournisseur si Role = FOURNISSEUR
                        .email(signupRequest.getEmail())
                        .username(signupRequest.getUsername())
                        .password(passwordEncoder.encode(signupRequest.getPassword()))
                        .firstName(signupRequest.getFirstName())
            ...
            case "ADMIN":
            default:
                user = User.builder() // <--- sinon créer un simple User
                        .email(signupRequest.getEmail())
                        .username(signupRequest.getUsername())
                        .password(passwordEncoder.encode(signupRequest.getPassword()))
                        .firstName(signupRequest.getFirstName())
    ...
    public AuthResponse signin(AuthRequest authRequest) {
        ...
        if (user == null) {
            throw new IllegalArgumentException("Le username ou le mot de passe est incorrect.");
        }
        ...
        authResponse.setRole(Role.valueOf(user.getRole().getName()));
